import { View, Text, StyleSheet, useColorScheme, TouchableOpacity, TextInput, Image, ScrollView } from 'react-native'
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: isDark ? 'black' : 'white' }]}>
      ...
      </View>
      {
        [...Array(10)].map((el, inx) => {
          return (
            <TouchableOpacity style={styles.User} key={inx} onPress={()=>navigate('SMS')}>
              <View style={{    
                width: '15%'
              }}>
                <Image
